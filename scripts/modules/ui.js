...
function displayHelp() {
	...
	const commandCategories = [
		{
			...
			commands: [
				{
					name: 'parse-prd',
					args: '--input=<file.txt> [--tasks=10] [--prefer-claude]',
					desc: 'Generate tasks from a PRD document using OpenAI (default) or Claude'
				},
				{
					name: 'generate',
					args: '',
	...
	envTable.push(
		[
			...
			`${chalk.dim('Required for Claude')}${chalk.reset('')}`
		],
		[
			`${chalk.yellow('OPENAI_API_KEY')}${chalk.reset('')}`,
			`${chalk.white('Your OpenAI API key')}${chalk.reset('')}`,
			`${chalk.dim('Required for OpenAI')}${chalk.reset('')}`
		],
		[
		...
		[
			`${chalk.yellow('OPENAI_MODEL')}${chalk.reset('')}`,
			`${chalk.white('OpenAI model to use')}${chalk.reset('')}`,
			`${chalk.dim(`Default: gpt-4o`)}${chalk.reset('')}`
		],
		[
			`${chalk.yellow('MAX_TOKENS')}${chalk.reset('')}`,
			`${chalk.white('Maximum tokens for Claude responses')}${chalk.reset('')}`,
			`${chalk.dim(`Default: ${CONFIG.maxTokens}`)}${chalk.reset('')}`
		],
		[
			`${chalk.yellow('OPENAI_MAX_TOKENS')}${chalk.reset('')}`,
			`${chalk.white('Maximum tokens for OpenAI responses')}${chalk.reset('')}`,
			`${chalk.dim(`Default: 4096`)}${chalk.reset('')}`
		],
		[
			`${chalk.yellow('TEMPERATURE')}${chalk.reset('')}`,
			`${chalk.white('Temperature for Claude responses')}${chalk.reset('')}`,
			`${chalk.dim(`Default: ${CONFIG.temperature}`)}${chalk.reset('')}`
		],
		[
			`${chalk.yellow('OPENAI_TEMPERATURE')}${chalk.reset('')}`,
			`${chalk.white('Temperature for OpenAI responses')}${chalk.reset('')}`,
			`${chalk.dim(`Default: 0.2`)}${chalk.reset('')}`
		],
		[
			`${chalk.yellow('PREFER_OPENAI')}${chalk.reset('')}`,
			`${chalk.white('Prefer OpenAI over Claude for all operations')}${chalk.reset('')}`,
			`${chalk.dim(`Default: true`)}${chalk.reset('')}`
		],
		[
			`${chalk.yellow('PREFER_CLAUDE')}${chalk.reset('')}`,
			`${chalk.white('Prefer Claude over OpenAI for all operations')}${chalk.reset('')}`,
